...
class RightUserTest(APITestCase):
    def setUp(self):
        self.username = 'admin'
        self.password = 'admin'
        self.user = User.objects.create_superuser('admin', 'admin@admin.com',
                                                  'admin')
    ...
    def test_delete_user(self):
        User.objects.create_superuser('user_to_delete', 'user@user.com',
                                      'user_to_delete')
        ...
        json_response = json.loads(response.render().content)
        self.assertEqual(json_response,
                         "User 'user_to_delete' delete successfully")
